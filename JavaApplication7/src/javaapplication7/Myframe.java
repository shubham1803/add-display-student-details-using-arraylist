...
class MyClass {
    ...
    public MyClass(String name,String course,int fees){
        this.name=name;
        this.course=course;
        this.fees=fees;
...
ArrayList<MyClass> obj=new ArrayList<MyClass>();
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.add(new MyClass(name,course,fees));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        System.out.println(obj.get(i).name+"\t"+obj.get(i).course+"\t"+obj.get(i).fees);
